...
import Bold from '@st/menus/bold.vue'
import Italic from '@st/menus/italic.vue'
import Underline from '@st/menus/underline.vue'
import Strike from '@st/menus/strike.vue'
...
import FontSize from '@st/menus/fontSize.vue'
import TextColor from '@st/menus/textColor.vue'
import BackgroundColor from '@st/menus/backgroundColor.vue'
import { type CollaborationEditorProps } from '@st/type'
import Ai from '@st/menus/ai/index.vue'
import AiBubbleMenu from '@st/menus/ai/ai-bubble-menu.vue'
